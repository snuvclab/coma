...
from utils_hand4whole.smplx import smplx


# from imports.Hand4Whole.common.utils_hand4whole.smplx import smpl_x
# from imports.config import cfg
...
class SMPLX(object):
    def __init__(self):
        ...
        self.layer = {
            "neutral": smplx.create(cfg.human_model_path, "smplx", gender="NEUTRAL", use_pca=False, use_face_contour=True, **self.layer_arg),
        ...
        self.pos_joint_part["R_MCP"] = [
            self.pos_joints_name.index("R_Index_1") - len(self.pos_joint_part["body"]) - len(self.pos_joint_part["lhand"]),
...
class SMPL(object):
    def __init__(self):
        ...
        self.layer = {
            "neutral": smplx.create(cfg.human_model_path, "smpl", gender="NEUTRAL", **self.layer_arg),
