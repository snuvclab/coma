...
if __name__ == "__main__":
    ...
    parser.add_argument("--corr-fname", required=True, type=str, dest="corr_fname", help="Filename with the head correspondences")
    ...
    parser.add_argument("--head-color", type=float, nargs=3, dest="head_color", default=(0.3, 0.3, 0.6), help="Color for the head vertices")
