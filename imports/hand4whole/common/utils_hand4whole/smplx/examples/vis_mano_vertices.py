...
if __name__ == "__main__":
    ...
    parser.add_argument("--corr-fname", required=True, type=str, dest="corr_fname", help="Filename with the hand correspondences")
    ...
    parser.add_argument("--hand", default="right", choices=["right", "left", "both"], type=str, help="Which hand to plot")
    parser.add_argument("--hand-color", type=float, nargs=3, dest="hand_color", default=(0.3, 0.3, 0.6), help="Color for the hand vertices")
