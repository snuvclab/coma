...
setup(
    ...
    url=URL,
    install_requires=["numpy>=1.16.2", "torch>=1.0.1.post2", "torchgeometry>=0.1.2"],
    extras_require={"pyrender": pyrender_reqs, "open3d": open3d_reqs, "matplotlib": matplotlib_reqs, "all": pyrender_reqs + matplotlib_reqs + open3d_reqs},
