...
if __name__ == "__main__":
    ...
    parser.add_argument("--mano-left-fn", dest="mano_left_fn", required=True, type=str, help="The path to the left hand MANO model")
    parser.add_argument("--mano-right-fn", dest="mano_right_fn", required=True, type=str, help="The path to the right hand MANO model")
    parser.add_argument("--output-folder", dest="output_folder", required=True, type=str, help="The path to the output folder")
