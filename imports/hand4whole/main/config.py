...
class Config:
    ...
    human_model_path = osp.join(root_dir, "common", "utils_hand4whole", "human_model_files")
...
from utils_hand4whole.dir import add_pypath, make_folder
