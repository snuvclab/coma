...
class VPoser(nn.Module):
    ...
    def sample_poses(self, num_poses, output_type="aa", seed=None):
        ...
        self.eval()
        with torch.no_grad():
            Zgen = torch.tensor(np.random.normal(0.0, 1.0, size=(num_poses, self.latentD)), dtype=dtype).to(device)
    ...
    def matrot2aa(pose_matrot):
        ...
        from utils.transformations import rotation_matrix_to_angle_axis
